    ...
    <div className='mb-10'>
      <div className="sm:hidden">
        ...
        <select
          id="tabs"
          name="tabs"
          className="block w-full rounded-md border-gray-300 focus:border-jira-accent-blue focus:ring-jira-accent-blue"
      ...
      <div className="hidden sm:block">
        <div className="border-b border-gray-200">
          <nav className="-mb-px flex space-x-8" aria-laFbel="Tabs">
            {tabs.map((tab) => (
              <Link
                key={tab.name}
                to={tab.href}
                className={classNames(
                  location.pathname === tab.href
                    ? 'border-jira-accent-blue text-jira-accent-blue'
              ...
              >
                <tab.icon
                  className={classNames(
                    location.pathname === tab.href ? 'text-jira-accent-blue' : 'text-gray-400 group-hover:text-gray-500',
                    '-ml-0.5 mr-2 h-5 w-5'
                  )}
                  aria-hidden="true"
                />
